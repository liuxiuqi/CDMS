...
namespace CDMS.Data
{
    public class RepositoryBase<T> : IRepository<T> where T : class
    {
        ...
        public IEnumerable<TReutrn> GetList<TReutrn>(string sql, Dictionary<string, object> parameters, CommandType type = CommandType.Text)
        {
            return client.GetList<TReutrn>(sql, parameters, type);
        }
        ...
        public TKey Add<TKey>(T model) where TKey : struct
        {
            ...
            return client.GetList<TKey>(sql.GetSql(), sql.GetParameters()).FirstOrDefault();
        }
        #endregion
